...
这不是总体优劣榜。Superpowers 更轻且方法成熟，OpenSpec 更流动且跨工具；Harness 为强制验收付出更高 token、耗时和流程成本。当前证据可以证明机械门禁存在，尚不能证明绝对更省 token 或总体 ROI 更高。固定版本对比、失败样本和证据边界见[竞争证据基线](docs/marketing/competitive-evidence.md)。
