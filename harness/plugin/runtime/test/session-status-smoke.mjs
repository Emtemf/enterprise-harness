...
const jsonKeys = ['summaryVersion', 'currentPhase', 'progressSnapshot', 'activeChange', 'nextStage', 'recommendedEntry', 'recommendedLane', 'truthSources', 'nextRead', 'nextCommands'];
const headings = ['当前阶段', '静态快照', '动态真相', '当前 workflow stage', '当前缺口', '推荐恢复入口', '下一步阅读', '下一步命令'];
