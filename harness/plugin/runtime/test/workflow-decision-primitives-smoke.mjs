...
const runtimePath = path.join(repoRoot, 'harness', 'plugin', 'runtime', 'workflow.mjs');
const libPath = path.join(repoRoot, 'harness', 'plugin', 'runtime', 'lib', 'workflow.mjs');
...
if (!['red', 'green', 'verify'].includes(mode)) {
  console.error('Usage: node harness/plugin/runtime/test/workflow-decision-primitives-smoke.mjs <red|green|verify>');
  process.exit(1);
}
