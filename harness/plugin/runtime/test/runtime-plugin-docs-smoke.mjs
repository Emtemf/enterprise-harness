...
const checks = [
  ...
  { ok: readme.includes('enterprise-harness') && readme.includes('node harness/plugin/runtime/cli.mjs'), why: 'README missing portable launcher / standalone fallback' },
  ...
  { ok: overview.includes('/enterprise-harness:harness') && overview.includes('standalone'), why: 'overview missing plugin-first positioning' },
