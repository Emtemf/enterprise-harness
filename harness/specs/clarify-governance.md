...
- The git-common-dir UserPromptSubmit binding is a privacy-preserving continuity receipt, not authorization evidence. It retains only prompt/clause digests and length, never prompt text; research applicability cannot be waived from that receipt.
