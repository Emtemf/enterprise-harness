...
优先阅读：
- verification brief（来自 inputRefs 或提示）
- validation artifact
- result artifact
...
输出 checker `HANDOFF_RESULT` 前读取 `skills/harness/reference/protocol/checker-verdict-contract.md`；需要 pass/block/advisory 示例时读取 `skills/harness/reference/protocol/checker-verdicts.md`。
