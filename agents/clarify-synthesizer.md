...
- 严格遵循预加载的 `harness protocol executor contract` 输出合同；需要具体字段时读取 `skills/harness/reference/protocol/executor-result-contract.md`。
- 需要最小完整结果示例时读取 `skills/harness/reference/protocol/executor-minimal.md`。
