...
required_dirs=(
  ...
  "$ROOT/.claude/skills/harness-design"
  "$ROOT/.claude/skills/harness-plan"
  "$ROOT/.claude/skills/harness-tdd"
  "$ROOT/.claude/skills/harness-verify"
  "$ROOT/hooks"
  "$ROOT/harness"
...
required_files=(
  ...
  "$ROOT/.claude/skills/harness-tdd/SKILL.md"
  "$ROOT/.claude/skills/harness-verify/SKILL.md"
  "$ROOT/harness/config.yaml"
  "$ROOT/harness/templates/state.json"
  "$ROOT/harness/templates/change.md"
  "$ROOT/harness/templates/spec.md"
  "$ROOT/harness/templates/requirements.md"
  ...
  "$ROOT/harness/plugin/runtime/update.mjs"
  ...
  "$ROOT/harness/plugin/runtime/lib/workflow.mjs"
