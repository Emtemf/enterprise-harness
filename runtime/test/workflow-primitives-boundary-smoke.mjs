...
const workflowRuntimePath = path.join(repoRoot, 'runtime', 'workflow.mjs');
const workflowLibPath = path.join(repoRoot, 'runtime', 'lib', 'workflow.mjs');
...
if (!['red', 'green', 'verify'].includes(mode)) {
  console.error('Usage: node runtime/test/workflow-primitives-boundary-smoke.mjs <red|green|verify>');
  process.exit(1);
}
