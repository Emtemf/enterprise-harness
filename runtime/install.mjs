...
if (help) {
  ...
  console.log('Usage: node runtime/install.mjs [--write-local-adapter]');
...
const bootstrap = spawnSync('node', ['runtime/bootstrap.mjs'], { cwd: repoRoot, encoding: 'utf-8' });
...
const setupArgs = ['runtime/setup-local-adapter.mjs'];
...
console.log('Next: run node runtime/doctor.mjs');
