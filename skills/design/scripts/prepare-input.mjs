...
try {
  ...
  if (state.impact?.api === 'yes') conditionalReferences.push('references/api-design.md');
  if (state.impact?.data === 'yes') conditionalReferences.push('references/data-design.md');
