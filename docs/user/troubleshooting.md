...
| `EH-HOOK-SKILL-SCRIPT-159` | supporting script 不是由当前 session、Skill、agent identity 与 dispatched run 共同授权 | 不要手工改写脚本路径或 runId；让 Main 使用 canonical `HANDOFF_INPUT` 重新派发对应 forked Skill |
